...
import PushNotification, { Importance, PushNotificationDeliveredObject, PushNotificationPermissions, PushNotificationScheduledLocalObject } from 'react-native-push-notification';
...
export default class NotifService {
  ...
  constructor(onRegister: unknown, onNotification: unknown) {
    this.lastId = 0;
