...
import NotifService from '../../config/pushNotif/NotifService';
...
const GetStartedScreen = () => {
  ...
  const handlePerm = (perms: PushNotificationPermissions) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.textField} value={registerToken} placeholder="Register token" />
      <View style={styles.spacer}></View>
      <TouchableOpacity
        style={styles.button}
        onPress={() => {
